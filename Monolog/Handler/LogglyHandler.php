...
namespace Seretalabs\Bundle\MonologFluentdBundle\Bundle\Monolog\Handler;
...
class MonologFluentdHandler extends AbstractProcessingHandler
{
    ...
    public function __construct($port = 24224, $host = 'localhost', $level = Logger::DEBUG, $bubble = true)
    {
        $this->port = $port;
        $this->host = $host;
